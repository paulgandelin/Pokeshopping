...
public class ProduitDAOImpl implements ProduitDAO {
    ...
    private message_erreur message_e;
    private message_reussite message_r;
    ...
    */
    public ArrayList<Produit> getAll() {
        ...
        try {
            ...
            e.printStackTrace();
            message_e.message_pb_connection();
        }
        return listeProduit;
    }
    @Override
    ...
    */
    ...
    try {
        ...
        if (lignesModifiees > 0) {
            ...
            message_e.erreur_recherche_produit(idProduit);
        }
            ...
            if (resultats.next()) {
                ...
                if (retour==0) {
                    ...
                    try (PreparedStatement preparedStatement = connexion.prepareStatement(deleteSQL)) {
                        ...
                        if (rowsAffected > 0) {
                            message.message_confirmation_produit(retour);
                        } else {
                            message.message_confirmation_produit(2);
                        }
                    }
                } else if (retour==1) {
                    message.message_confirmation_produit(retour);
                ...
                message_e.message_entite_inconnue();
            }
