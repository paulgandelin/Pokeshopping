...
public class Affichage_graph {
    ...
    public Affichage_graph(DaoFactory daoFactory) {
    ...
    public Map<String, Integer> recupererTypeProduitsVendus() {
        ...
        for (Commande cmd : commandesPayees) {
            ...
            if (produit == null) {
                message.erreur_recherche_produit(cmd.getIdProduit());
                continue;
            }

            String description = produit.getDescription_courte();
            if (description == null) {
                message.erreur_description_produit(produit.getId_produit());
